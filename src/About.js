        ...
        <div className="accordion" id="accordionExample" style={myStyle}>
            ...
            <div className="accordion-item" style={myStyle}>
                ...
                <div className="accordion-body" style={myStyle}>
                    ...
                    character count and word count statistics for a given text. TextUtils
            ...
            <div className="accordion-item" style={myStyle}>
                ...
                <div className="accordion-body" style={myStyle}>
                    ...
                    such as chrome, Firefox, Internet Explorer, Safari, Opera. It 
                    suitsto count to character facebook, blog books,excel documents
